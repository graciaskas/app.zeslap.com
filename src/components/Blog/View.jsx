...
function View(props) {
    ...
    async function fetchPost() {
        ...
        if (!params.has('q') || isNaN(params.get('q'))) {
          setError({
            content: 'Invalid url request or search parameter value ! ' + params.get('q'),
            code: 400
          });
          return;
        }
  ...
  return (
    <div className='container'>
      ...
      <AppBar appName='Blogs' title={post.id} create={false} showPagination={false} data={ [] } />
        ...
        <div className="border rounded p-4">
          <div className="d-flex border-bottom position-relative pb-2">
            ...
            <div style={{ marginLeft: "5px", marginTop: "-5px" }}>
              ...
              <small className="d-block" style={{ fontSize: ".75rem" }}>Software developer.</small>
            </div>
            {
              post.read ?
                <small
            ...
            <div className="py-3">
                ...
                <span style={{ marginLeft: '15px' }}>
                    <i className="fa fa-clipboard-list"></i> Business expertise | Tupac Shakur
                </span>
               </div>
                <div className='mt-4' ref={postContentRef}/>
            </div>
        ...
        <div className="comments">
          ...
          <div class="comment d-flex align-items-start mt-3">
            ...
            <div class="text " style={{ marginLeft:'7px'}}>
                ...
                <p>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab optio amet doloremque saepe dolorum similique ullam, quas excepturi molestias itaque fugiat labore? Aspernatur consequatur facilis sunt placeat quisquam sit quod?
                </p>
                <div className="d-flex justify-content-end">
                  <small class="date bg-primary-light-7 rounded-pill px-2">2 Days ago.</small>
                </div>
              </div>
          </div>
        </div>
