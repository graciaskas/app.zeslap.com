    ...
    <header className="main-header bg-white shadow-default p-2 d-flex  align-items-center">
          <div className="container">
            ...
            <form action="" className="w-50 rounded-pill bg-gray">
                <input type="text" placeholder="Search" className="w-100 bg-gray rounded-pill"/>
            </form>
            <nav className="header__icons d-flex align-items-center justify-content-center">
                ...
                <li  className="dropdown">
                    <Link
                        ...
                        aria-expanded="false">
                        <i className="fa fa-user-circle"></i> Gracias Kasongo
                    </Link>

                    <ul className="dropdown-menu  p-4 shadow-default border-0 rounded" aria-labelledby="dropdownProducts">
                        <li><Link to='/profile' className="dropdown-itemx">My profile</Link></li>
                        <li><Link to='/preferences' className="dropdown-itemx">My Preferences</Link></li>
                        <hr />
                        <li>
