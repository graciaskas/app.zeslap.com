    ...
    return (
        <div className="col-12 mb-3">
            <div className="d-flex flex-wrap align-items-center justify-content-between bg-white rounded shadow-default p-3 ">
                ...
                <h5 className='text-secondary h5 text-raleway' style={{ marginBottom:'2px'}}>
                    <Link to={'/'}><i className='fa fa-home' /></Link> /
                    <Link to={linkToPath}>{appName}</Link> /
                    {create && (<Link to={linkTo}>Create</Link>)}
                    {title}
                </h5>
                    ...
                    showPagination && (
                        <div className="pagination" role={'link'}>
                            <li className="page-item dropdown">
                                <Link to="#" className="page-link dropdown-toggle" id="dropdownFilters" data-bs-toggle="dropdown">
                                    <i className='fa fa-filter'></i> Filter
                                </Link>
                                <ul className="dropdown-menu p-4 shadow-default border-0 rounded w-auto" aria-labelledby="dropdownFilters">
                                    <li><Link href="#" className="dropdown-itemx">All</Link></li>
                                    <li><Link href="#" className="dropdown-itemx">Archived</Link></li>
                                    <li><Link href="#" className="dropdown-itemx">Not activated</Link></li>
                                    <li><Link className='dropdown-itemx'><i className='fa fa-plus-circle' /> Custom filter</Link></li>
                                </ul>
                            </li>
