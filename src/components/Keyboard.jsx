...
function Keyboard(props) {
    ...
    return (
        <div className="col-12">
            <div className="text__editor  mt-3 bg-white p-3 rounded shadow-default" ref={docRef} >

                <div className="pagination flex-wrap" role={'list'}>
                    <li className="page-item">
                        <Link className="page-link bg-white option-button  save-pdf" style={{ marginRight:'7px'}}>
                    ...
                    <li className="page-item bg-white">
                        <Link id='redo' className='page-link option-button bg-white ' role={'button'}>
                            <i className='fa fa-redo'/>
                        </Link>
                    </li>
                   
                    <li className='page-item bg-white'>
                        <div className="page-link d-flex bg-white justify-content-between align-items-center" >
                    ...
                    <li className='page-item bg-white'>
                        <div className="page-link bg-white d-flex justify-content-between align-items-center">
                    ...
                    <li className="page-item bg-white">
                        <div className='page-link bg-white d-flex align-items-center border  px-2'>
                            <input type="color" name="" id="foreColor" className='adv-option-button'/>
                            <label htmlFor="foreColor">Font</label>
                        </div>
                    </li>

                    <li className='page-item bg-white'>
                        <div className="d-flex align-items-center page-link bg-white">
                            <input type="color" name="" id="backColor"  className='adv-option-button'/>
                            <label htmlFor="backColor">Background</label>
                        </div>
                    </li>

                    <li className='page-item bg-white'>
                        <div className="d-flex justify-content-between align-items-center page-link bg-white">
                ...
                <div className='pagination flex-wrap mt-1'>
                    ...
                    <li className="page-item bg-white">
                        <Link role={'button'} id='bold' className='page-link format bg-white'>
                            <i className='fa fa-bold'/>
                        </Link>
                    </li>
                    
                    <li className="page-item bg-white">
                        <Link role={'button'} id='italic' className='page-link format bg-white'>
                            <i className='fa fa-italic'/>
                        </Link>
                    </li>

                    <li className="page-item bg-white">
                        <Link role={'button'} id='underline' className='page-link format bg-white'>
                            <i className='fa fa-underline'/>
                        </Link>
                    </li>

                    <li className="page-item bg-white">
                        <Link role={'button'} className="page-link format bg-white" id='strikethrough'>
                            <i className='fa fa-strikethrough' />
                        </Link>
                    </li>

                    <li className="page-item bg-white">
                        <Link role={'button'} className="page-link bg-white" id='superscript'>
                    ...
                    <li className="page-item bg-white">
                        <Link role={'button'} className="page-link bg-white" id='insertOrderedList'>
                            <i className='fa fa-list-ol'/>
                        </Link>
                    </li>

                    <li className="page-item bg-white">
                        <Link role={'button'} className="page-link bg-white"  id='insertUnorderedList'>
                    ...
                    <li className="page-item bg-white">
                        <Link role={'button'} className="page-link bg-white" id='justifyLeft'>
                            <i className='fa fa-align-left'/>
                        </Link>
                    </li>

                    <li className="page-item bg-white">
                        <Link role={'button'} className="page-link bg-white" id='justifyCenter'>
                            <i className='fa fa-align-center'/>
                        </Link>
                    </li>

                    <li className="page-item bg-white">
                        <Link role={'button'} className="page-link spacing bg-white" id='justifyRight'>
                            <i className='fa fa-align-right'/>
                        </Link>
                    </li>

                    <li className="page-item bg-white">
                        <Link role={'button'} className="page-link bg-white" id='justifyFull'>
                    ...
                    <li className="page-item bg-white">
                        <Link href="" className="page-link bg-white" data-active="false"  id='showCode'>
                ...
                <div
                    id='textInput'
                    className="p-4 mt-3 border-top rounded shadow d-block"
